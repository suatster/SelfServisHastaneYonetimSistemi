...
//		//Buradan itibaren db etkilesimleri ile degistirildi, debugging icin kalacak.
...
//		randevuObs.addAll(r1, r2); //r1 ve r2 listeye ekleniyor, database ile değiştirilecek.
	...
	private ArrayList<Randevu> randevulariGetirDBden() {
		...
		String sql = "SELECT r.saat, r.tarih, " +
				"d.id as doktor_id, d.isim AS doktor_isim, d.alan AS doktor_alan, d.eposta AS doktor_eposta, d.telefon AS doktor_tel, " +
				"h.id as hasta_id, h.isim AS hasta_isim, h.eposta AS hasta_eposta, h.telNo AS hasta_tel, h.kimlikNo, h.sifre " +
				"FROM randevu r " +
				"JOIN doktor d ON r.doktor_isim = d.isim " +
